...
export interface Translations {
    ...
    pushNotifTitle: string;
    pushNotifActive: string;
    pushNotifDesc: string;
    pushNotifActiveDesc: string;
    pushNotifConsentTitle: string;
    pushNotifConsentBody: string;
    pushNotifConsentAgree: string;
    pushNotifConsentCancel: string;
    pushNotifCenterTitle: string;
    pushNotifMarkAllRead: string;
    pushNotifClearAll: string;
    pushNotifEmpty: string;
    pushNotifEmptyDesc: string;
    pushNotifDelete: string;
    daily: string;
