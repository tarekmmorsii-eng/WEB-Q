...
export const translations: Record<Language, Translations> = {
    ar: {
        ...
        updateAvailable: 'يتوفر تحديث جديد للمصحف 🚀',
        updateDescription: 'يتضمن تحسينات هامة وإصلاحات لمشكلة الصوت.',
        ...
        downloadSuccess: '✅ تم التحميل بنجاح! التطبيق جاهز للاستخدام بدون إنترنت.',
        ...
        browserNotificationDescription: 'يصلك حتى لو التطبيق في الخلفية (يتطلب إذن)',
