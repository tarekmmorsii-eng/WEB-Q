...
export default function AyahOptionsModal({
    ...
    return (
        ...
        >
            <div
                className="w-full max-w-[280px] rounded-xl shadow-xl border border-[var(--border-primary)] p-3 relative animate-in zoom-in-95 duration-200 bg-[var(--bg-card)] text-[var(--text-primary)]"
            >
                {/* Header */}
                ...
                <button
                    onClick={onClose}
                    className="w-full text-[var(--text-primary)] opacity-50 hover:opacity-100 py-1 transition-colors text-[10px] font-medium"
                >
                    {t.close}
                </button>
                ...
                {showTafsir && (
                    <div className="absolute inset-0 bg-[var(--bg-card)] rounded-xl z-20 flex flex-col p-3 animate-in slide-in-from-bottom-5 duration-300">
                        <div className="flex justify-between items-center mb-2">
                            <h3 className="text-sm font-bold text-[var(--text-primary)]">{t.tafsirAyah}</h3>
                            <button
                                onClick={() => {
                                    setShowTafsir(false);
                                    onClose();
                        ...
                        <div
                            className={clsx("flex-1 overflow-y-auto text-[var(--text-primary)] opacity-80 leading-relaxed text-sm pb-2 px-1", t.dir === 'rtl' ? "text-right" : "text-left")}
                            dir={t.dir}
                        ...
                        <button
                            ...
                            className="w-full bg-[var(--bg-secondary)] text-[var(--text-primary)] py-2 rounded-lg font-bold text-xs transition-colors mt-1 border border-[var(--border-primary)]"
                        >
                            {t.close}
                        </button>
                    </div>
